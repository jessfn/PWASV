  ...
  <div :class="['sidebar', { 'collapsed': isCollapsed }]">
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li class="nav-item" :class="{ active: $route.name === 'NotificacionesIndividuales' }" v-if="tienePermiso('notificaciones')">
          <router-link to="/notificaciones-individuales" class="nav-link">
            <div class="nav-icon-container">
              <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
            ...
            <span class="nav-text">Notificaciones Individuales</span>
          </router-link>
          <div class="nav-indicator"></div>
        </li>
